...
D3D11_RASTERIZER_DESC CRenderer::m_RasterizerDesc = {};
ID3D11RasterizerState* CRenderer::m_RasterizerState = NULL;
...
void CRenderer::SetRasterizerStateMode(D3D11_FILL_MODE fillMode, D3D11_CULL_MODE cullMode)
{
	// ラスタライザステート設定
	...
	m_D3DDevice->CreateRasterizerState(&m_RasterizerDesc, &m_RasterizerState);
